...
import ru.madmax.pet.microcurrency.currate.model.ConversionRequestX;
...
public class AppControllerV1 {
    ...
    @PostMapping("/convert")
    public Mono<ResponseEntity<ConversionResponse>> weatherRequest(@RequestBody @Valid ConversionRequestX request,
